...
parser.add_argument('--B', type=int, default=200, help='batch size')
parser.add_argument('--P', type=int, default=1, help='prefix length')
...
llm = LLMEngine(max_length=MAX_LEN,batch_size=BATCH_SIZE, model_name=args.model)
...
torch.cuda.synchronize()
t2 = time.time()
print("Max Length :{}, Decode Length :{}, Prefix Length :{}, Batch Size:{}, inference time:{}s".format(MAX_LEN, DEC_LEN, PREFIX_LEN, BATCH_SIZE, (t2 - t1)/ T))
